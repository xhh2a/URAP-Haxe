...
:: Android packaging
set AND_CERT_NAME="CleanFighterAndroid"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\CleanFighterAndroid.p12
...
set IOS_PROVISION=cert\CleanFighterAndroid.mobileprovision
...
set APP_ID=air.cleanfighter.CleanFighterAndroid

:: Output packages
set DIST_PATH=dist
set DIST_NAME=CleanFighterAndroid
